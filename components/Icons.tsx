...
export const CloudIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M20 16.2A4.5 4.5 0 0 0 3.6 12.2" />
    <path d="M20 16.2c.4 0 .8.1 1.1.2" />
    <path d="M8.6 12.2A6 6 0 0 1 20 7.8" />
    <path d="M17.5 19H22" />
    <path d="M2 19h4.5" />
    <polyline points="9 19 11.5 19 11.5 15.5" />
    <polyline points="16 19 13.5 19 13.5 15.5" />
  </svg>
);
